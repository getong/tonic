...
fn coerce_request(mut req: Request<Incoming>, encoding: Encoding) -> Request<Incoming> {
...
mod tests {
    ...
    impl tower_service::Service<Request<Incoming>> for Svc {
